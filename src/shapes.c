...
ModelData cube_shape() {
    return init_model(verts, 8, tris, 12, NULL, 0, NULL, 0, NULL);
}

ModelData icosahedron_shape() {
    return init_model(verts_ico, 12, tris_ico, 20, NULL, 0, NULL, 0, NULL);
}
...
ModelData square_shape() {
    ...
    return init_model(square_verts, 4, square_tris, 2, NULL, 0, NULL, 0, NULL);
}
